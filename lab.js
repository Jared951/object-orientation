...
/*
  ...
  to be 'Harry Potter'. (If they were either of those things already, change them to something else.)
*/
...
let toby = new Cat('Toby', 12, 'black')
...
let voldemort = new Wizard('voldemort', 100, 'a curse')
voldemort.castSpell()
...
/*
    ...
    We want that to be false since 
...
let phoneOne = new Phone('Apple', '14', 100, 'black', 1099)
let phoneTwo = new Phone('Andriod', '15', 101, 'white', 1200)
let phoneThree = new Phone('Samsung', '16', 140, 'grey', 1500)
/* 
...
let myFirstVehicle = new Vehicle(4, 'red', 100000)
...
let myFirstMotorcycle = new Motorcycle(2, 'blue', 2500, 'Honda', true)
...
let myFirstBoat = new Boat(10, 'green', 5000, 'Boat Company', 'Shipping Vessel', false)
